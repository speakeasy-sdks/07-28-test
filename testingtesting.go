...
import (
	"fmt"
	"github.com/speakeasy-sdks/07-28-test/v3/internal/hooks"
...
type SDKOption func(*TestingTesting)

// WithServerURL allows the overriding of the default server URL
func WithServerURL(serverURL string) SDKOption {
	return func(sdk *TestingTesting) {
...
func New(opts ...SDKOption) *TestingTesting {
	sdk := &TestingTesting{
		sdkConfiguration: sdkConfiguration{
			Language:          "go",
			...
			SDKVersion:        "3.1.0",
			GenVersion:        "2.258.0",
			UserAgent:         "speakeasy-sdk/go 3.1.0 2.258.0 1.0.0 github.com/speakeasy-sdks/07-28-test",
			Hooks:             hooks.New(),
		},
	}
